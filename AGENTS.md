...
**BelaSayank** is a WhatsApp AI agent system that connects WhatsApp accounts to
...
`STICKER_PACK_NAME` (default "BelaSayank"), `STICKER_EMOJI` (default "🤖"),
